...
// ─── Server data loader (kept as a server component wrapper in real use) ──────
// NOTE: In your actual app, keep the async DB call in a server component and
// pass `projects` down as a prop. This file shows the client UI only.
